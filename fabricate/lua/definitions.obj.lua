...
--- @param input (Source | Output)[] The inputs used.
--- @param variables { [string]: string } The variable values.
--- @param implicitDependencies (Source | Output)[] Implicit dependencies.
--- @return Output
function Rule:build(output, input, variables, implicitDependencies) end
